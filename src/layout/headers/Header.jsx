  ...
  return (
    <>
      <AppBar
        position="static"
        color="whiteMain"
        sx={{ width: "100%", height: "70px", boxShadow: 0 }}
      >
...
<<<<<<< HEAD
    ...
    return (
        <>
            <AppBar position="static" color="whiteMain" sx={{ width: "100%", height: "66px", boxShadow: 0 }}>
                        ...
                        <Toolbar disableGutters="true" sx={{ width: '100%' }}>
                            ...
                            <Typography>
                                <NavLink to="/">
                                    <IconButton
                                        //Medidas oficiales 163 ancho y 40 de largo
                                        sx={{ mt: "9px", mb: "15px", ml: "72px", width: "163px", height: "40px" }}
                                    >
                                        <img src={logo} alt={'Logo Principal'} />
                                    </IconButton>
                                </NavLink>
                            ...
                            <Grid container direction="row" justifyContent="end" >
                                ...
                                <Box sx={{ display: 'flex' }}>
                                    ...
                                    <NavLink to="/shopping-cart">
                                        <IconButton sx={{ mt: "10px", mb: "19px", mr: '71px', width: 29, height: 36, }}>
